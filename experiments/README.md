...
| [EXP-0002](EXP-0002-rmsnorm-simdgroup-reduction/report.md) | 2026-08-22 | Apple GPU RMSNorm SIMD-group reduction | Does one hybrid SIMD-group reduction materially improve a real decode or prefill regime without a relevant regression? | Planned | Operation | No variant or paired measurement yet. | Protocol pending commit | Baseline remains public pending evidence |
