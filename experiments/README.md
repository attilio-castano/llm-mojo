...
| [EXP-0004](EXP-0004-linear-decode-baseline/report.md) | 2026-08-25 | Apple GPU M=1 projection baseline | What latency does the one-output-per-SIMD-group baseline establish for Q, KV, hot QKV, and rotating 24-layer QKV? | Planned; timing complete | Operation | Clean M4 Pro/Metal medians: Q 0.009471 ms, KV 0.010181 ms, hot QKV 0.032821 ms, rotating QKV 0.951752 ms; profiling pending. | Harness and timing `b659b7b` | Retain timing baseline; close bounded profiles before completion |
