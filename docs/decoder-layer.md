...
The reference-package handoff, the implementation checkpoint and the
completed baseline measurement are recorded in
[history](history/decoder-layer-implementation.md).
