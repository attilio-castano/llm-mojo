...
| [EXP-0004](EXP-0004-linear-decode-baseline/report.md) | 2026-08-25 | Apple GPU M=1 projection baseline | What latency does the one-output-per-SIMD-group baseline establish for Q, KV, hot QKV, and rotating 24-layer QKV? | Planned | Operation | No recorded result. | Pending | Establish baseline before candidate timing |
