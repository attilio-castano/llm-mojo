...
| [Streamlining, September 2026](streamlining-2026-09.md) | One-step setup and a shared model store, one production path with explicit execution plans, and current docs separated from history | Executed in three stacked changes | [Documentation map](../README.md) |
| [Shared oracle fixtures, September 2026](shared-fixtures-2026-09.md) | Why validation keeps one verified copy of the large oracle fixtures in the shared store, and the runs that checked it | Executed as one change | [Shared oracle fixtures](../development.md#shared-oracle-fixtures) |
