...
| [EXP-0003](EXP-0003-rmsnorm-limiter-counters/report.md) | 2026-08-22 | Apple GPU RMSNorm limiter counters | Do matched Performance Limiters traces show a repeatable device-counter difference between the shared-tree and SIMD-group implementations at rows=512? | Complete | Operation | Threadgroup-memory L1 read/write bandwidth fell about 95–96% in both pair directions; global GPU/LLC bandwidth was inconsistent. | Capture `0bc8ce9`; analysis `f15ce45` | Supports lower threadgroup-memory pressure; no production-decision change and no direct barrier-stall claim |
